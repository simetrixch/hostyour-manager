...
// check run-definitions.total (server/boot/selfchecks.ts) asserts the narrower runtime property — no family
 ...
 *  field the run-definitions map files the definition under — so the field is the implementation's own claim. */
