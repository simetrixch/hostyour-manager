...
// No Tenant doc here — the Tenant CR is provisioned by the Controller, never rendered by a chart, so a
...
function ports(over: Partial<TenantOnboardPorts> & FakeKube = {}): TenantOnboardPorts {
  ...
  return {
    ...
    registry: new TenantRegistry(seededPlatformRepo(), CLUSTER_STAGE),
