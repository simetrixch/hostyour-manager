 ...
 */
export function listServers(db: Db, flags?: Map<string, ServerCredFlags>): ServerView[] {
  return db
    .select()
    .from(servers)
    .all()
...
export function getServer(db: Db, id: string, flags?: Map<string, ServerCredFlags>): ServerView | undefined {
