...
function entry(over: Partial<TenantRegistration> = {}): TenantRegistration {
  return {
    ...
    members: testMembers([{ name: "erp", seedReference: false, seedDemo: false, selections: {} }]), identityProvider: "auth", routing: "host", ownDomain: "", ownDomainRedirects: [], approvedTags: {}, apps: [{ name: "erp", seedReference: false, seedDemo: false, selections: {} }],
...
function ports(reg: TenantRegistrations, over: FakeKube & { buildRbac?: FakeBuildRbacWriter } = {}): TenantLifecyclePorts {
  return {
    registrations: reg,
