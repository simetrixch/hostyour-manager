...
// to this installation's platform tier. A Manager that held one could mint buckets and keys for
// the whole account; a Manager that is handed one key can use one bucket. So the values arrive
// the way every other operator-supplied secret does, through approve, and the Manager's part is
