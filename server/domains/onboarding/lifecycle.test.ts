...
// attest-target reads only ctx.db + the resolved clusterReader, so the rest of the ports (registry)
// are irrelevant here — cast a partial to keep the test decoupled from the sibling TenantRegistry. The
