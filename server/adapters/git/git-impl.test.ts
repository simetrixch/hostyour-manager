...
import { GitConsumerRepo, GitPlatformRepo, GitRepoReader } from "./git.ts";
...
` }] }),
          ...
          // worktree with no run lock (domains/onboarding/api.ts -> registry.listConsumerRegistrations).
