...
function consumerPorts(reg: Registry, cluster: FakeClusterReader): LifecyclePorts {
  return {
    registry: reg,
...
function tenantPorts(reg: TenantRegistry, cluster: FakeClusterReader): TenantLifecyclePorts {
  return {
    registry: reg,
    resolver: new FakeClusterKubeResolver({
      clusterReader: cluster,
