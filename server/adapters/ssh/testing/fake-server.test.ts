...
describe("startFakeSshServer", () => {
  // The fixture used to draw its host key straight from ssh2's generateKeyPairSync. Roughly 1 draw
  // in 256 of that generator is a pair ssh2's own parser rejects, and `new Server` parses hostKeys
  // in its constructor, so a bad draw threw out of the fixture before it could return a port. One
