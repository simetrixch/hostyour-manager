 ...
 *
 * Written by the Controller rather than by the relay's chart, for a reason the relay cannot solve: a
 ...
 *  build name IS the flat registry repository and the build-name uniqueness gate lets exactly one unit
