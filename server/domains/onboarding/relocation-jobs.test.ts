...
// Controller's own env. It must still never be written onto the jobSpec: the Job object and the pod it
...
const IMAGE = "registry.example/dbtools:1.0.0";
...
describe("runRelocationJob places and reaps the box credential", () => {
  it("the credential STANDS while the job runs and is gone afterwards", async () => {
    ...
    // Resolvable AT RUN TIME with the credential the Controller carries...
